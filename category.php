...
{
    $query = 'delete from category where CategoryID='.$_GET['id_delete'];
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <form role="form" id="category_form" method="post" enctype="multipart/form-data">
                            ...
                            <a href="add_category.php" class="btn btn-success">Add</a>
                        </div>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:650px">
                                                <img src="images/category/<?php echo $row['CatImg'];?>"  height="80" width="80">
                                            </td>
                                            <td style="width:650px"><?php echo $row["CatDis"] ?></td>
